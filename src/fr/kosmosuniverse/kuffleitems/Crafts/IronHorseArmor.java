...
public class IronHorseArmor extends ACrafts {
	...
	public IronHorseArmor(KuffleMain _km) {
		name = "IronHorseArmor";
		
		recipe = new ShapedRecipe(new NamespacedKey(_km, name), new ItemStack(Material.IRON_HORSE_ARMOR));
	...
	public Inventory getInventoryRecipe() {
		...
		for (int i = 0; i < 27; i++) {
			if (i == 0) {
				...
				inv.setItem(i, new ItemStack(Material.IRON_HORSE_ARMOR));
			} else if (i == 3 || i == 4) {
